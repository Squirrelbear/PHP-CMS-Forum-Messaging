// OLD CODE for the old menu system
...
{
	len = document.form1.users.length
	selected = "none";
	for(i = 0; i<len; i++)
	{
		if(document.form1.users[i].selected)
		{
			selected = document.form1.users[i].value;
			document.form1.user.value = selected;
		}
	}
	return selected;
}
